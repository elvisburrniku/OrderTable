        ...
        <div className=" mx-auto p-6 space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure basic system preferences including timezone,
                formatting, and regional settings
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Choose your restaurant's local timezone for accurate
                          booking times
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="12h">
                        Test format - 12 Hour (2:30 PM)
                      </SelectItem>
                      <SelectItem value="24h">
                        Test format - 24 Hour (14:30)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Default currency for pricing and financial displays
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </Label>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="USD">
                        Test currency - USD ($) - US Dollar
                      </SelectItem>
                      <SelectItem value="EUR">
                        Test currency - EUR (€) - Euro
                      </SelectItem>
                      <SelectItem value="GBP">
                        Test currency - GBP (£) - British Pound
                      </SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Interface language for the restaurant management
                          system
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Default length of time allocated for each table
                            booking
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="90 minutes">
                          Test option - 1.5 hours
                        </SelectItem>
                        <SelectItem value="120 minutes">
                          Test option - 2 hours
                        </SelectItem>
                        <SelectItem value="150 minutes">
                          Test option - 2.5 hours
                        </SelectItem>
                        <SelectItem value="180 minutes">
                          Test option - 3 hours
                        </SelectItem>
                        <SelectItem value="240 minutes">
                          Test option - 4 hours
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Minimum empty seats to keep available at each table
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </Label>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Buffer time between bookings for table preparation
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </Label>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="0 min.">
                          Test option - 0 min.
                        </SelectItem>
                        <SelectItem value="15 min.">
                          Test option - 15 min.
                        </SelectItem>
                        <SelectItem value="30 min.">
                          Test option - 30 min.
                        </SelectItem>
                        <SelectItem value="45 min.">
                          Test option - 45 min.
                        </SelectItem>
                        <SelectItem value="60 min.">
                          Test option - 60 min.
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Required contact information for booking
                            confirmation
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <div>
                        ...
                        <div className="flex gap-4 mt-2">
                          <div className="flex items-center space-x-2">
                            <Switch
                              checked={
                                bookingSettings.showRoomNumberField.manual
                              }
                              onCheckedChange={(checked) =>
                                setBookingSettings({
                                  ...bookingSettings,
                          ...
                          <div className="flex items-center space-x-2">
                            <Switch
                              checked={
                                bookingSettings.showRoomNumberField.online
                              }
                              onCheckedChange={(checked) =>
                                setBookingSettings({
                                  ...bookingSettings,
                      ...
                      <div>
                        ...
                        <div className="flex gap-4 mt-2">
                          <div className="flex items-center space-x-2">
                            <Switch
                              checked={
                                bookingSettings.showPromoCodeField.manual
                              }
                              onCheckedChange={(checked) =>
                                setBookingSettings({
                                  ...bookingSettings,
                          ...
                          <div className="flex items-center space-x-2">
                            <Switch
                              checked={
                                bookingSettings.showPromoCodeField.online
                              }
                              onCheckedChange={(checked) =>
                                setBookingSettings({
                                  ...bookingSettings,
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="30 min.">
                          Test interval - 30 min.
                        </SelectItem>
                        <SelectItem value="45 min.">
                          Test interval - 45 min.
                        </SelectItem>
                        <SelectItem value="60 min.">
                ...
                <div>
                  <Label htmlFor="fromName" className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Business name that appears in customer email
                          signatures
                        </p>
                      </TooltipContent>
                    </Tooltip>
                ...
                <div>
                  ...
                  >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Email address used for all outgoing notifications and
                          confirmations
                        </p>
                      </TooltipContent>
                    </Tooltip>
                    ...
                    {emailSettings.enableBookingReminders && (
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="1">
                              Test option - 1 hour before
                            </SelectItem>
                            <SelectItem value="2">
                              Test option - 2 hours before
                            </SelectItem>
                            <SelectItem value="4">
                              Test option - 4 hours before
                            </SelectItem>
                            <SelectItem value="6">
                              Test option - 6 hours before
                            </SelectItem>
                            <SelectItem value="12">
                              Test option - 12 hours before
                            </SelectItem>
                            <SelectItem value="24">
                              Test option - 24 hours before
                            </SelectItem>
                            <SelectItem value="48">
                              Test option - 48 hours before
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
